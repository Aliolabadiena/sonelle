...
- [claude-code-transcript-cost](claude-code-transcript-cost.md) - Claude Code logs per-session usage at ~/.claude/projects/<cwd-with-separators-as-dashes>/*.jsonl (message.usage); sum it for cost with no API key (how tools\cost.ps1 works).
